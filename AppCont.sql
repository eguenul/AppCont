CREATE DATABASE  IF NOT EXISTS `AppCont` /*!40100 DEFAULT CHARACTER SET dec8 COLLATE dec8_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `AppCont`;
-- MySQL dump 10.13  Distrib 8.0.25, for Linux (x86_64)
--
-- Host: localhost    Database: AppCont
-- ------------------------------------------------------
...
-- Dump completed on 2021-09-27 15:05:03
